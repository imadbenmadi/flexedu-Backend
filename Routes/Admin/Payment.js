...
router.get("/Summary", Admin_midllware, async (req, res) => {
    try {
...
router.get("/Summary/:summaryId", Admin_midllware, async (req, res) => {
...
router.post("/Summary/:summaryId/Accept", Admin_midllware, async (req, res) => {
            ...
            await Student_Notifications.create(
                {
                    ...
                    type: "payment_accepted",
                    StudentId: studentId,
                    link: `/Student/Purchased/Summary/${summary.id}`,
                },
                { transaction: t }
            );
        } catch (error) {
...
router.post("/Summary/:summaryId/Reject", Admin_midllware, async (req, res) => {
    const { summaryId } = req.params;
    const { studentId } = req.body; // We need studentId from the request body, same as in Accept
